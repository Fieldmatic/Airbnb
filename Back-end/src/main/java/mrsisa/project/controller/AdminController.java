...
public class AdminController {
    ...
    public ResponseEntity<String> addAdventure(@RequestBody ProfileDeletionReasonDTO pdrDTO, @PathVariable("id") Long id)
    {
        boolean isSent = adminService.deleteInstructor(id, pdrDTO);
        if (!isSent)
