...
INSERT INTO address(city, state, street, zip_code) VALUES ('Novi Sad', 'Srbija', 'Arse Teodorovica 2', '21000');
INSERT INTO instructor(id,active, email, last_password_reset_date, name, password, phone_number, profile_photo, surname, username, address_id, approved_account, points, registration_explanation, category_id) VALUES (199,true, 'bane.geric00@gmail.com',null,'bane','$2a$10$fJ7XTUdyAdhGlY3yzsHo3egRkxlVWufriPJvL1FSJzQ1HOvSVIY0u','06534343', null, 'geric', 'banzg', 2, true, 0, 'yes', null);
INSERT INTO user_role(user_id, role_id) VALUES ('banzg', 4);
INSERT INTO price_list(cancellation_conditions, daily_rate, end_date_time, hourly_rate, start_date_time, bookable_id) VALUES ('Mozete uvek otkazati', 0, null, 300, null, null);

INSERT INTO adventure(id, name, profile_picture, promotional_description, rating, rules, address_id, price_list_id, instructor_id) VALUES (199, 'Avanturica', null, 'Dozivite nezaboravno iskustvo', 8.4, 'Sve je dozvoljeno', 2, 2, 199);
